...
for asmfile in (asmfiles + tblfiles + macfiles + hdrfiles + equfiles + incfiles + hfiles):
    ...
    for line in lines:
        ...
        if ".FILE" in line:
            ...
            out.write(line.replace("#", "*"))          # Wierd comments in lines.
        elif "#" in line and "jruc" in line:
            out.write(line.replace("#", ""))          # jrucs
        elif "#" in line and "jrlt" in line:
            out.write(line.replace("#", ""))          # label madness
        elif "#" in line and "jreq" in line:
            out.write(line.replace("#", ""))          # label madness
        elif "#" in line and "jrn" in line:
            out.write(line.replace("#", ""))          # label madness
        elif "#" in line and "jrz" in line:
            out.write(line.replace("#", ""))          # label madness
        elif "#" in line and "dsj" in line:
            out.write(line.replace("#", ""))          # label madness
        elif ".TITLE" in line:
            out.write(line.replace("'", "\""))          # GSPA 6.10
